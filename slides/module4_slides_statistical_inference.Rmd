...
load("example_datasets/students/studentsFall2017.RData")
...
About 31.7% of respondents to the ANES sample favored ending birthright citizenship.
...
The movie, crime, and titanic data all share this feature that they are not samples that we can infer to larger populations. The sexual frequency, politics, and Add Health data, however, are all samples of the US population. 
