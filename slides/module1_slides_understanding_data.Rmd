...
knitr::opts_chunk$set(fig.retina = 3, message=FALSE, warning=FALSE, fig.height=6.5)
```
...
| --- | ----------- | ------ | 
| ![crowd](images/slides/crowd.jpg) | ![countries](images/slides/countries.jpg) | ![logos](images/slides/logos.jpg) | ![pac12](images/slides/pac12.png)|
...
df <- data.frame(x=c(x_group1, x_group2),
                 group=factor(c(rep("Group 1",200),
                                rep("Group 2",200))))
df$y <- 5+-0.25*df$x+12*(df$group=="Group 2")+rnorm(400, 0, 3)
