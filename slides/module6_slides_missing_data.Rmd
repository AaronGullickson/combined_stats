...
The different probabilities of missingness depend both on observed and unobserved variables. In this case, we cannoty fully correct for bias that might result from missing data. 
]
...
- Preditive imputation moves the assumption from MAR to MCAR if the model is good.
