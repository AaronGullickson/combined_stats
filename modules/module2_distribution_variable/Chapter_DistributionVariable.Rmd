...
We can calculate this in R by just taking our previous command and dividing by its own sum:

```{r}
classes <- table(titanic$pclass)
classes/sum(classes)
```
...
```{r piechart_passclass}
p <- table(titanic$pclass)/sum(table(titanic$pclass))
pie(p)
```
...
```{r barplot_passclass, fig.width=5, fig.height=4, out.width='500px', out.height='400px', dpi=300}
...
```{r hist_agepol, fig.width=5, fig.height=4, out.width='500px', out.height='400px', dpi=300}
...
```{r hist_agepol_bin5, fig.width=5, fig.height=4, out.width='500px', out.height='400px', dpi=300}
...
```{r hist_examples, echo=FALSE, error=FALSE, warning=FALSE, fig.width=5, fig.height=4, out.width='500px', out.height='400px', dpi=300}
