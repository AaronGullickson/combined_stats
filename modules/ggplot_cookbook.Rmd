...
Figure \@ref(fig:comp-dotplot) shows the resulting dotplot. If that is a little too spartan for you, you could try a lollipop graph, shown in Figure 8. The `geom_lollipop` is in the `ggalt` library.
