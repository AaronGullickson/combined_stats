...
In the interactive *R* session below, use <tt>ggplot</tt> to construct a histogram of the distrivbution of family income from the politics dataset using the <tt>income</tt> variable. Keep the following in mind:
