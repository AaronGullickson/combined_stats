...
Slides for this module can be found [here](stat_slides/module2_slides_distribution_variable.html).
...
```{r echo=FALSE}
knitr::include_url("https://www.youtube.com/embed/H_4zOv7_0g0")
```
...
```{r echo=FALSE}
knitr::include_url("https://www.youtube.com/embed/h_MPc89f8wY")
```
...
In the interactive *R* session below, try to calculate the proportion or percent of the voting age population that voted for each candidate (or didn't vote) in the 21016 election, based on our politics dataset. Keep the following in mind:
...
<iframe src="dcl_interactives/calculate_props.html" frameborder="0" scrolling="no" style="width:100%;height:405px"></iframe>
...
<iframe src="dcl_interactives/barplot.html" frameborder="0" scrolling="no" style="width:100%;height:405px"></iframe>
...
```{r echo=FALSE}
knitr::include_url("https://www.youtube.com/embed/tIALiP-sEV0")
```
...
2. Play around with the size of bins in your histogram by adding a `binwidth` argument to `geom_histogram`. 
3. Play around with the border and fill color of your histogram bars with the `col` and `fill` arguments to `geom_histogram`. 
4. Be sure to add nice labels for your x axis by adding a <tt>labs</tt> command. 

<iframe src="dcl_interactives/histogram.html" frameborder="0" scrolling="no" style="width:100%;height:405px"></iframe>
...
```{r echo=FALSE}
knitr::include_url("https://www.youtube.com/embed/_6ZIRls5gl8")
```
...
```{r echo=FALSE}
knitr::include_url("https://www.youtube.com/embed/OuZ3TtvIzMg")
```
...
```{r echo=FALSE}
knitr::include_url("https://www.youtube.com/embed/_-96k4oGdm0")
```
...
```{r echo=FALSE}
knitr::include_url("https://www.youtube.com/embed/orXsuQ8I6ks")
```
...
1. To identify the variable you want for the <tt>mean</tt> and <tt>median</tt> you need to follow the syntax of <tt>dataset$variable_name</tt>.
...
```{r echo=FALSE}
knitr::include_url("https://www.youtube.com/embed/8sOWBj0QES0")
```
...
```{r echo=FALSE}
knitr::include_url("https://www.youtube.com/embed/lp-ZhOr2xCY")
```
...
```{r echo=FALSE}
knitr::include_url("https://www.youtube.com/embed/x-Ops3m_u1c")
```
