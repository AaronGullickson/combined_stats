...
For this analysis, we will use the same data extract from the [American Community Survey](https://www.census.gov/programs-surveys/acs) that we used for the reading and writing data lab. I downloaded this extract from [IPUMS](https://usa.ipums.org/usa/). You can download the file [here](https://aarongullickson.github.io/stat_book/resources/usa_00084.data.gz). You can also [view the codebook](https://aarongullickson.github.io/stat_book/resources/usa_00084.cbk.txt) that IPUMS provides
