...
In this module, we will learn about how to visualize and measure association between two variables. How we do this depends on the kinds of variables that we have. There are three possibilitites:

* two categorical variables
* one categorical and one quantitative variable
* two quantitative variables

Each of these cases requires that we learn and master different techniques. In the three sections that follow, we will learn how to measure assocation for all three cases. 
...
tab.prop <- cbind(tab.prop,rep(1,3))
